...
public void reset (){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laundry Zaxzz");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 160, 40));
        ...
        combo_jenis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "Basah", "Kering", "Setrika" }));
        combo_jenis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                combo_jenisActionPerformed(evt);
            }
        });
        jPanel1.add(combo_jenis, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 90, -1));
        ...
        jPanel1.add(txt_berat, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 220, -1));
        ...
        jPanel1.add(txt_harga, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 220, -1));
        ...
        jPanel1.add(txt_ttlHarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, 220, -1));
        ...
        jPanel1.add(txt_bayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 220, -1));
        ...
        jPanel1.add(btn_transaksi, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, 100, -1));
        ...
        jPanel1.add(btn_batal, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, 100, -1));

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, 0, 410, 460);

        setSize(new java.awt.Dimension(416, 466));
    ...
    private void combo_jenisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combo_jenisActionPerformed
        ...
        if (combo_jenis.getSelectedItem().equals("Pilih")) {
         txt_harga.setText("");
         
        } else if (combo_jenis.getSelectedItem().equals("Basah")) {
              txt_harga.setText("3000");
        }else if (combo_jenis.getSelectedItem().equals("Kering")) {
    ...
    private void btn_transaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_transaksiActionPerformed
        if (txt_harga.getText().isEmpty()  || txt_berat.getText().isEmpty() || txt_ttlHarga.getText().isEmpty() ) {
          JOptionPane.showMessageDialog(null, "Data Harus Diisi");
            ...
            if (kembalian <=0) {
                 JOptionPane.showMessageDialog(null, "Cari uang dulu");
            }
